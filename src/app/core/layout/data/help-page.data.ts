...
export const HELP_PAGE_HERO = {
  ...
  lead:
    'Короткие упражнения на карточках, сценарии под вашу цель и учебные программы с прогрессом. От первого слова до технического интервью — всё в едином, понятном формате.',
