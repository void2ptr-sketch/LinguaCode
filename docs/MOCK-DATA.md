...
{
  "version": 1,
  "cardFiles": ["/cards/demo-cards.json", "/cards/perl-interview-cards.json"],
  "scenarioFiles": ["/scenarios/demo-scenarios.json", "/scenarios/perl-interview-scenarios.json"],
  "courseFiles": ["/courses/demo-courses.json", "/courses/perl-interview-course.json"]
}
```
