...
| ---------------- | ---------------------- |
| `han-only`       | 你好                   |
| `han-palladius`  | 你好 + _ни хао_ (ruby) |
| `han-pinyin`     | 你好 + _nǐ hǎo_        |
...
- Ложный вариант: `yínxíng` (неверное чтение 行 как xíng вне контекста банка)
...
**Схема `classic` (по умолчанию):** палитра [Nathan Dummit, _Chinese Through Tone & Color_ (2008)](https://en.wikipedia.org/wiki/Tone_number#Color): 1-й — красный · 2-й — оранжевый · 3-й — зелёный · 4-й — синий · нейтральный — чёрный. Та же схема используется в MDBG и ряде словарей.
